...
<svelte:head>
	<title>Sign In | Logmaxing</title>
	<meta name="description" content="Sign in to your Logmaxing account." />
</svelte:head>
...
<div class="flex min-h-screen items-center justify-center bg-zinc-950 px-6">
	<div class="w-full max-w-sm">
		...
		<p class="mt-6 text-center text-sm text-zinc-400">
			...
			<a href="/sign-up" class="text-purple-400 transition-colors hover:text-purple-300">Sign up</a>
		</p>
	</div>
</div>
